...
expectedMarc1b = Marc21Record
  ...
  , controlFields =
      ...
      , ControlField
          { tagId = 8
          , controlData = "041207s2004    dcu     s    f000 0 eng c"
          }
      ]
  , varFields =
      [ VariableDataField
          ...
          , dataElements =
              ...
              , DataElement { dataElementId = 'f' , dataField = "paper copy" }
              ]
          }
      , VariableDataField
          { indicator1 = Nothing
          , indicator2 = Nothing
          , dataElements =
              [ DataElement { dataElementId = 'a' , dataField = "GPO" }
              , DataElement { dataElementId = 'c' , dataField = "GPO" }
              , DataElement { dataElementId = 'd' , dataField = "MvI" }
              , DataElement { dataElementId = 'd' , dataField = "MvI" }
              ]
          }
      , VariableDataField
          ...
          , indicator2 = Nothing
          , dataElements =
              [ DataElement { dataElementId = 'a' , dataField = "pcc" } ]
          }
      , VariableDataField
          { indicator1 = Nothing
          , indicator2 = Nothing
          , dataElements =
              [ DataElement { dataElementId = 'a' , dataField = "n-us---" } ]
          }
      , VariableDataField
          { indicator1 = Nothing
          , indicator2 = Nothing
          , dataElements =
              [ DataElement
                  { dataElementId = 'a' , dataField = "0546-D (online)" }
              ]
          }
      , VariableDataField
          { indicator1 = Just '0'
          ...
          , dataElements =
              [ DataElement
                  { dataElementId = 'a' , dataField = "GA 1.13:GAO-05-126" }
              ]
          }
      , VariableDataField
          { indicator1 = Nothing
          , indicator2 = Nothing
          , dataElements =
              [ DataElement { dataElementId = 'a' , dataField = "GAO-05-126" } ]
          }
      , VariableDataField
          { indicator1 = Just '1'
          , indicator2 = Nothing
          , dataElements =
              [ DataElement
                  { dataElementId = 'a' , dataField = "United States." }
              , DataElement
                  { dataElementId = 'b'
                  , dataField = "Government Accountability Office."
                  }
              ]
          }
      , VariableDataField
          ...
          , dataElements =
              [ DataElement
                  { dataElementId = 'a' , dataField = "Aviation security" }
              , DataElement
                  { dataElementId = 'h' , dataField = "[electronic resource] :" }
              , DataElement
                  { dataElementId = 'b'
                  , dataField =
                      "preliminary observations on TSA's progress to allow airports to use private passenger and baggage screening services : report to the Chairman, Subcommittee on Aviation, Committee on Transportation and Infrastructure, House of Representatives."
                  }
              ]
          }
      , VariableDataField
          ...
          , dataElements =
              ...
              , DataElement
                  { dataElementId = 'b'
                  , dataField =
                      "preliminary observations on Tranportation Security Administration's progress to allow airports to use private passenger and baggage screening services."
                  }
              ]
          }
      , VariableDataField
      ...
      , VariableDataField
          ...
          , dataElements =
              [ DataElement
                  { dataElementId = 'a' , dataField = "[Washington, D.C.] :" }
              , DataElement
                  { dataElementId = 'b'
                  , dataField = "U.S. Government Accountability Office,"
                  }
              , DataElement { dataElementId = 'c' , dataField = "[2004]" }
              ]
          }
      , VariableDataField
          { indicator1 = Nothing
          , indicator2 = Nothing
          , dataElements =
              [ DataElement { dataElementId = 'a' , dataField = "text" }
              , DataElement { dataElementId = '2' , dataField = "rdacontent." }
              ]
          }
      , VariableDataField
          { indicator1 = Nothing
          , indicator2 = Nothing
          , dataElements =
              [ DataElement { dataElementId = 'a' , dataField = "computer" }
              , DataElement { dataElementId = '2' , dataField = "rdamedia." }
              ]
          }
      , VariableDataField
          { indicator1 = Nothing
          ...
          , dataElements =
              [ DataElement
                  { dataElementId = 'a' , dataField = "online resource" }
              , DataElement { dataElementId = '2' , dataField = "rdacarrier." }
              ]
          }
      , VariableDataField
          { indicator1 = Nothing
          ...
          , dataElements =
              [ DataElement
                  { dataElementId = 'a'
                  , dataField = "Title from title screen (viewed on Dec. 2, 2004)"
                  }
              ]
          }
      , VariableDataField
          ...
          , dataElements =
              [ DataElement
                  { dataElementId = 'a' , dataField = "\"November 2004.\"" }
              ]
          }
      , VariableDataField
          { indicator1 = Nothing
      ...
      , VariableDataField
          ...
          , dataElements =
              [ DataElement
                  { dataElementId = 'a' , dataField = "\"GAO-05-126.\"" }
              ]
          }
      , VariableDataField
          { indicator1 = Nothing
          ...
          , dataElements =
              [ DataElement
                  { dataElementId = 'a'
                  , dataField = "Includes bibliographical references."
                  }
              ]
          }
      , VariableDataField
          ...
          , dataElements =
              [ DataElement
                  { dataElementId = 'a'
                  , dataField =
                      "Mode of access: Internet from GPO Access web site. Address as of 12/02/04: http://frwebgate.access.gpo.gov/cgi-bin/getdoc.cgi?dbname=gao&docid=f:d05126.pdf; current access available via PURL."
                  }
              ]
          }
      , VariableDataField
          ...
          , dataElements =
              ...
              , DataElement
                  { dataElementId = 'b'
                  , dataField = "Transportation Security Administration"
                  }
              , DataElement
                  { dataElementId = 'v' , dataField = "Rules and practice" }
              , DataElement { dataElementId = 'x' , dataField = "Evaluation." }
              ]
          }
      , VariableDataField
          { indicator1 = Nothing
          ...
          , dataElements =
              [ DataElement
                  { dataElementId = 'a' , dataField = "Aeronautics, Commercial" }
              , DataElement
                  { dataElementId = 'x' , dataField = "Security measures" }
              , DataElement { dataElementId = 'z' , dataField = "United States" }
              , DataElement { dataElementId = 'x' , dataField = "Evaluation." }
              ]
          }
      , VariableDataField
          ...
          , dataElements =
              [ DataElement
                  { dataElementId = 'a'
                  , dataField = "Airline passenger security screening"
                  }
              , DataElement { dataElementId = 'z' , dataField = "United States" }
              , DataElement { dataElementId = 'x' , dataField = "Evaluation." }
              ]
      ...
      , VariableDataField
          ...
          , dataElements =
              [ DataElement
                  { dataElementId = 'a' , dataField = "United States." }
              , DataElement { dataElementId = 'b' , dataField = "Congress." }
              , DataElement { dataElementId = 'b' , dataField = "House." }
              , DataElement
                  { dataElementId = 'b'
                  , dataField = "Committee on Transportation and Infrastructure."
                  }
              , DataElement
                  { dataElementId = 'b' , dataField = "Subcommittee on Aviation." }
              ]
          }
      , VariableDataField
          { indicator1 = Just '4'
          ...
          , dataElements =
              [ DataElement
                  { dataElementId = 'u'
                  , dataField = "http://purl.access.gpo.gov/GPO/LPS56006"
                  }
              , DataElement
                  { dataElementId = 'z' , dataField = "View online version" }
              ]
          }
      , VariableDataField
          { indicator1 = Nothing
          , indicator2 = Nothing
          , dataElements =
              [ DataElement { dataElementId = 'a' , dataField = ".b37991772" }
              , DataElement { dataElementId = 'b' , dataField = "06-10-15" }
              , DataElement { dataElementId = 'c' , dataField = "07-26-05" }
              ]
          }
      , VariableDataField
          { indicator1 = Nothing
          , indicator2 = Nothing
          , dataElements =
              [ DataElement { dataElementId = 'a' , dataField = "es001" }
              , DataElement { dataElementId = 'b' , dataField = "07-26-05" }
              , DataElement { dataElementId = 'c' , dataField = "m" }
              , DataElement { dataElementId = 'd' , dataField = "a" }
              , DataElement { dataElementId = 'e' , dataField = "-" }
              , DataElement { dataElementId = 'f' , dataField = "eng" }
              , DataElement { dataElementId = 'g' , dataField = "dcu" }
              , DataElement { dataElementId = 'h' , dataField = "0" }
              , DataElement { dataElementId = 'i' , dataField = "1" }
              ]
          }
      , VariableDataField
          { indicator1 = Nothing
          , indicator2 = Nothing
          , dataElements =
              [ DataElement { dataElementId = 'a' , dataField = "MARCIVE" } ]
          }
      , VariableDataField
          { indicator1 = Nothing
          , indicator2 = Nothing
          , dataElements =
              [ DataElement
                  { dataElementId = 'a' , dataField = "Hathi Trust report None" }
              ]
          }
      , VariableDataField
          { indicator1 = Nothing
          , indicator2 = Nothing
          , dataElements =
              [ DataElement { dataElementId = 'g' , dataField = "0" }
              , DataElement { dataElementId = 'j' , dataField = "0" }
              , DataElement { dataElementId = 'l' , dataField = "esb  " }
              , DataElement { dataElementId = 'o' , dataField = "n" }
              , DataElement { dataElementId = 'p' , dataField = "$0.00" }
              , DataElement { dataElementId = 'q' , dataField = " " }
              , DataElement { dataElementId = 'r' , dataField = " " }
              , DataElement { dataElementId = 's' , dataField = "-" }
              , DataElement { dataElementId = 't' , dataField = "255" }
              , DataElement { dataElementId = 'u' , dataField = "0" }
              , DataElement { dataElementId = 'v' , dataField = "0" }
              , DataElement { dataElementId = 'w' , dataField = "0" }
              , DataElement { dataElementId = 'x' , dataField = "0" }
              , DataElement { dataElementId = 'y' , dataField = ".i138993580" }
              , DataElement { dataElementId = 'z' , dataField = "07-26-05" }
              ]
          }
      ]
  }
